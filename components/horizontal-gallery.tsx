        ...
        <CardStack
          ...
          renderCard={(item, { active }) => (
            ...
            >
              ...
              {/* active tap hint */}
              {active && (
                <div className="absolute top-4 right-4 px-3 py-1 rounded-full bg-white/10 backdrop-blur-sm border border-white/15 text-white/60 text-[10px] font-medium uppercase tracking-widest">
