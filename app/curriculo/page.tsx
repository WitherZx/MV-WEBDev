                            ...
                            <div className="relative bg-zinc-950/80 backdrop-blur-xl border border-white/10 p-6 rounded-3xl flex flex-col gap-6 shadow-2xl">
                                ...
                                <div className="flex items-center justify-between gap-4">
                                    <div className="flex items-center gap-2">
                                        ...
                                        <a href="https://instagram.com/odevmarcos" target="_blank" className="w-9 h-9 rounded-xl bg-white/5 border border-white/10 flex items-center justify-center hover:bg-accent hover:border-accent hover:text-white transition-all duration-300 shadow-lg">
                                            <Instagram size={18} />
                                        </a>
